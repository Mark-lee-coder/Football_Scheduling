...
import com.example.footballscheduling.constructors.Fixture;
import com.example.footballscheduling.R;
import com.example.footballscheduling.constructors.Teams;
import com.example.footballscheduling.adapters.AdapterFixtureTeam;
                        ...
                        for (Fixture<Teams> fixture1 : round) {
                            ...
                            roundReference.child("match" + matchCounter).setValue(map1).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(FixtureGenerator.this);
                                    builder.setMessage("Fixtures generated successfully");
                                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
