...
import com.example.footballscheduling.activities.TeamsAndPlayers1;

import java.util.ArrayList;
import java.util.Map;

public class AdapterFixtures1 extends RecyclerView.Adapter<AdapterFixtures1.MyViewHolder> {
    ArrayList<ArrayList<Map>> mList;
    Context context;

    public AdapterFixtures1(Context context, ArrayList<ArrayList<Map>> mList){
        this.mList = mList;
    ...
    @NonNull
    @Override
    public AdapterFixtures1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.fixture_view, parent, false);
        return new AdapterFixtures1.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterFixtures1.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, TeamsAndPlayers1.class);
